...
public class VehicalType {
	...
	private String unit;
	private ArrayList<CategotySubType> subTypes;

	public ArrayList<CategotySubType> getSubTypes() {
		return subTypes;
	}

	public void setSubTypes(ArrayList<CategotySubType> subTypes) {
		this.subTypes = subTypes;
		Log.d("subtype",subTypes+"");
	}
