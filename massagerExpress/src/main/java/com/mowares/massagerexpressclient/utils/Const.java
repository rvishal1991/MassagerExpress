...
public class Const {
    // constant for menu
    public static final String TAG = "NokNok";
    public static int menu_newNok = 1;
    public static int menu_futureNok = 1;
    public static int menu_mynok = 1;
    public static int menu_customerService = 1;
    public static int menu_getReady = 1;
    public static int menu_myProfile = 1;
    // public static final String PLACES_AUTOCOMPLETE_API_KEY =
    // "AIzaSyAKe3XmUV93WvHJvII4Qzpf0R052mxb0KI";

    // temp key AIzaSyCqcD3tNdTc8uUpa8j1D4_BXUi1Vtr5QF0
    //AIzaSyCQlhQBJ3o1pRXkulJ49LRT309IzLhSvZ4
    public static final String PLACES_AUTOCOMPLETE_API_KEY = "AIzaSyCQlhQBJ3o1pRXkulJ49LRT309IzLhSvZ4"; // Our key
    ...
    // card io
    public static final String PUBLISHABLE_KEY = "pk_test_cMwUBWxWC858tTTSWSi8ZTz0";
    public static final String MY_CARDIO_APP_TOKEN = "c15fa417f757415c9d750d1ef5ee5fd8";

    // web services
    public class ServiceType {
        private static final String HOST_URL = "http://noknok.cloudapp.net/";

        // private static final String HOST_URL =
        // "http://192.168.0.57/Doctor/api/public/";
        ...
        public static final String GET_TYPE = HOST_URL + "provider/types";
        // public static final String CREATE_REQUEST = BASE_URL +
        // "createrequest";
        public static final String CREATE_REQUEST_PROVIDER = BASE_URL
                + "createrequestproviders";
        ...
        public static final String GET_PROVIDERS = BASE_URL + "getproviders_new";
        public static final String GET_PROVIDERS_SUBTYPE = BASE_URL + "getproviders_subtype";
        public static final String GET_PROVIDERS_LATER = BASE_URL + "getproviders_later?";
        public static final String GET_PROVIDERSALL = BASE_URL + "getprovidersall";
        ...
        public static final String VERIFY_CODE = BASE_URL + "otp_verification";
        public static final String SLOTS = BASE_URL + "slotsforclient";
        public static final String CREATE_REQUEST_PROVIDER_LATER = BASE_URL + "createrequestproviderslater";
        // http://uberforxapi.provenlogic.com/provider/rating";

    }

    // prefname
    public static String PREF_NAME = "MassagerExpressClient";
    ...
    public static String FRAGMENT_VERIFY = "FRAGMENT_VERIFY";
    ...
    public class ServiceCode {
        ...
        public static final int CREATE_REQUEST_PROVIDER = 8;
        ...
        public static final int GET_PROVIDERS_LIST = 41;
        public static final int VERIFY_CODE = 42;
        public static final int GET_TYPE = 43;
        public static final int GET_PROVIDERS_SUBTYPE = 44;
        public static final int SLOTS = 45;
        public static final int CREATE_REQUEST_PROVIDER_LATER = 46;
        public static final int GET_PROVIDERS_LATER = 47;
    }
    ...
    public class Params {
        ...
        public static final String PROFILE_COMPLETE = "profilecomplited";
    ...
    public static final int IS_CANCELLED = 7;
    ...
    public static final int ALREADY_REGISTERED = 402;
