...
public class CircleImageView extends ImageView {
	...
	public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		if(attributes.getBoolean(R.styleable.CircleImageView_border, true)) {
			setBorderWidth(attributes.getColor(R.styleable.CircleImageView_border_width, 4));
			setBorderColor(attributes.getInt(R.styleable.CircleImageView_border_color, Color.WHITE));
		}
